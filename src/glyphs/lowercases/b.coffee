	...
	contours:
		...
		1:
			...
			nodes:
				...
				2:
					x: Math.max(
						contours[0].nodes[1].expandedTo[1].x + ( ( 103 / 90 ) * thickness ) * 0.25,
						200 * width + 345
					) - (71)
		...
		2:
			...
			nodes:
				0:
					...
					dirOut: 180 + 'deg'
				1:
					x: contours[0].nodes[0].expandedTo[1].x + ( contours[1].nodes[3].expandedTo[0].x - contours[0].nodes[0].expandedTo[1].x ) * Math.min( 0.3, ( 0.3 / 90 ) * thickness )
